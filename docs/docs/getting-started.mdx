...
See [Core Concepts — Animated Transitions](/docs/concepts#animated-transitions) for the phase lifecycle and a full example, or grab ready-made `crossfade()` and `slide()` factories from [Transitions](/docs/api/transitions).
